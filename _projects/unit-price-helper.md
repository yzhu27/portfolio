...
#### [Unit Price Helper](https://github.com/yzhu27/UnitPriceHelper)
...
1. **Install:** Grab it from the Chrome Web Store → [Unit Price Helper](https://chromewebstore.google.com/detail/unit-price-helper/edclfclmeehfhbdkoliopgbjgfifnoln).
...
<figure class="post-photo" style="max-width: 80%; margin: 1.5rem auto; text-align: center;">
  <img src="https://raw.githubusercontent.com/yzhu27/UnitPriceHelper/main/images/feature_3.png" alt="unitepricehelper_feature" style="width: 100%; height: auto;">
</figure>
